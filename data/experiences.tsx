export const experiences = [
  ...
  },
  {
    ...
    description:
      "A Thai tech startup that has accumulated experience from co-creating large-scale projects for both the public and private sectors.",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      "Worked in the Software Development section, developing web applications for the university.",
    responsibilities: [
